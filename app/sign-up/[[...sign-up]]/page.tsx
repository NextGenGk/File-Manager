    ...
    <div className="relative min-h-screen bg-black flex items-center justify-center pt-20">
      ...
      <div className="relative z-20 w-full max-w-md px-4">
        <div className="text-center mb-8">
          ...
          <p className="text-neutral-400">Create your account to access 5GB of free cloud storage</p>
        </div>
        <SignUp
          appearance={{
            elements: {
              ...
              socialButtonsBlockButton: "rounded-xl border-white/20 hover:bg-white/10 text-white !bg-black [&_svg]:filter [&_svg]:invert [&_svg]:brightness-0 [&_svg]:invert",
              ...
              socialButtonsProviderIcon: "[&_svg]:filter [&_svg]:invert [&_svg]:brightness-0 [&_svg]:invert",
              providerIcon: "[&_svg]:filter [&_svg]:invert [&_svg]:brightness-0 [&_svg]:invert"
            },
            variables: {
