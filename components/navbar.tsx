          ...
          <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl px-6 py-2 shadow-xl">
            <div className="flex justify-between items-center">
              ...
              <Link href="/" className="flex items-center space-x-4 group">
                <motion.div
                    className="w-10 h-10 bg-white/20 backdrop-blur-sm rounded-lg flex items-center justify-center shadow-lg group-hover:shadow-xl geist-transition border border-white/30"
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                >
                  <FolderOpen className="w-6 h-6 text-white" />
                </motion.div>
                <span className="text-2xl font-bold text-white leading-none font-geist-sans">XyStorage</span>
              </Link>
